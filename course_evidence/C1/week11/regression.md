...
- Targeted metadata scan over `main.py`, `tests/roles/c1`, and `course_evidence/C1` for `*_REPO`, `*_COMMIT`, `*_SOURCE_URL`, `http(s)://`, and full 40-character hexadecimal strings: **no matches**.
